...
import (
	...
	"github.com/droot/godocbot/pkg/client/clientset/versioned"
	"github.com/droot/godocbot/pkg/inject"
...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "PullRequest Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	defer GinkgoRecover()
	Eventually(func() interface{} { return arguments.ControllerManager.GetController("PullRequestController") }).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("PullRequestController")
})
